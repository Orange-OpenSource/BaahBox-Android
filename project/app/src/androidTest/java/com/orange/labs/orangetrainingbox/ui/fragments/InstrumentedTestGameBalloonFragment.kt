...
class InstrumentedTestGameBalloonFragment {
    ...
    fun layoutTextContents(){
        ...
        onView(allOf(instanceOf(TextView::class.java), withParent(withId(R.id.toolbar))))
            .check(matches(withText(appContext!!.getString(R.string.title_game_balloon))))

        // Test the text contents
        onView(withId(R.id.tvLine1)).check(matches(withText(appContext!!.getString(R.string.game_balloon_instructions_line_1))))
        onView(withId(R.id.tvLine2)).check(matches(withText(appContext!!.getString(R.string.game_balloon_instructions_line_2))))
    ...
    fun playButton() {
        ...
        onView(withId(R.id.clBalloonGamePlaying)).check(matches(isDisplayed()))
    }
    ...
    private fun goToGame(){
        onView(withText(appContext!!.getString(R.string.title_game_balloon))).perform(click())
    }
